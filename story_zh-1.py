...
class Person_en:
  def __init__(self, dict):
    ...
    self.dad = dict['父親']
    self.eats = dict['愛吃']
    self.eat_desc1 = dict['愛吃樣子一']
    self.eat_desc2 = dict['愛吃樣子二']
    self.disg = dict['討厭吃']
    self.disg_desc1 = dict['討厭吃樣子一']
    self.disg_desc2 = dict['討厭吃樣子二']
...
故事一a = f"{person1}想吃麵。{person1}很想吃麵。{person1}很想吃素麵。{person1}吃素，不吃肉。{person1}吃什麼呢？吃麵嗎？吃飯嗎？吃餅嗎？沒有！沒有！沒有！"
故事一b = f"{person1}想吃麵。{person1}很想吃麵。{person1}很想吃素麵。{person1}吃素，不吃肉。{person1}吃什麼呢？吃麵嗎？吃飯嗎？吃餅嗎？沒有！沒有！沒有！"
